...
import bgImage from '../img/heros/pravila/podatci-o-tvrtki-hero.png';
...
import paralTwo from '../img/sections/PARAL-DOWN.png';
import arrowIcon from '../img/icons/article-arrow-subpage-thin.svg';

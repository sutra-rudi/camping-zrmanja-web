...
export const content_eng =
  'Explore unlimited adventures, from exciting rafting trips on the Zrmanja River to discovering the wilderness of Velebit. Experience unforgettable moments in the heart of untouched nature. Our guests are entitled to a 10% discount on all Riva Rafting activities.';
